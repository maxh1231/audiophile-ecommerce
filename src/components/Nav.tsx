...
import mobileSpeakerMenu from '../assets/home/mobile/image-speaker-zx9.png'
...
const Nav = () => {
    ...
    return (
        <div className="flex flex-col">
            ...
            {activeMenu &&
                <div className="relative h-[750px] bg-[#FFFFFF] width-full flex flex-col items-center justify-evenly">
                    <div className="w-[325px] h-[165px] rounded-xl bg-[#F1F1F1]">
                        <Link href='/headphones'>Headphones</Link>
                        <p className="text-black">Shop &gt;</p>
                    </div>
                    <div className="w-[325px] h-[165px] rounded-xl bg-[#F1F1F1]">
                        <img src={mobileSpeakerMenu.src} alt="" className="w-[84px] h-[101px]" />
