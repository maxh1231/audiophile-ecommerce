...
function PagePreviewTablet(): JSX.Element {
    return <Image src="/assets/product-xx99-mark-one-headphones/tablet/image-category-page-preview.jpg" className='rounded-lg' alt="earphones" width={750} height={352} />
}
function PagePreviewDesktop(): JSX.Element {
    return <Image src="/assets/product-xx99-mark-one-headphones/desktop/image-category-page-preview.jpg" className='rounded-lg' alt="earphones" width={372} height={352} />
}
    ...
    return (
        <div className='mx-[24px] h-[724px]'>
            ...
            <div className='flex flex-col items-center justify-end my-2'>
                ...
                <p className='opacity-50 font-medium text-lg text-black text-center px-2 my-4 md:w-3/4'>As the gold standard for headphones, the classic XX99 Mark I offers detailed and accurate audio reproduction for audiophiles, mixing engineers, and music aficionados alike in studios and on the go.</p>
