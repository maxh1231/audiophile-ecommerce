...
const YX1Earphones = (): JSX.Element => {
    return (
        <div className="mx-[24px] flex flex-col md:flex-row md:justify-center">
            <div className=" bg-mobile-yx1 h-[200px] rounded-md bg-cover 
            md:bg-tablet-yx1 md:w-[350px] md:h-[350px] md:bg-center md:mr-4 lg:w-[500px]"></div>
            <div className="h-[200px] bg-[#F1F1F1] rounded-md mt-6 flex flex-col items-start justify-center md:w-[350px] md:h-[350px] md:m-0 md:pl-8 lg:w-[500px]">
