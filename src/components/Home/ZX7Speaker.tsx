...
const ZX7Speaker = (): JSX.Element => {
    return (
        <div className="flex flex-col items-start justify-center bg-mobile-zx7 h-[320px] bg-cover bg-right mx-[24px] rounded-lg md:bg-tablet-zx7 md:pl-8 max-w-[1024px] md:m-auto">
