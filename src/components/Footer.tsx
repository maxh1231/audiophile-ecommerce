...
function facebookIcon(): JSX.Element {
    return <Image src="/assets/shared/desktop/icon-facebook.svg" alt="earphones" width={24} height={24} />
}

function twitterIcon(): JSX.Element {
    return <Image src="/assets/shared/desktop/icon-twitter.svg" alt="earphones" width={24} height={24} />
}

function instagramIcon(): JSX.Element {
    return <Image src="/assets/shared/desktop/icon-instagram.svg" alt="earphones" width={24} height={24} />
}
